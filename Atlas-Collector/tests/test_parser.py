...
from atlas_collector.xml import (
    EmptyUiDumpError,
    Parser,
    StructuredXmlParser,
    parse_device_xml,
...
def test_importing_the_package_does_not_import_pil():
    """A fresh interpreter must import atlas_collector.xml with PIL absent from sys.modules.
    ...
    """
    code = (
        "import sys; import atlas_collector.xml as m; "
