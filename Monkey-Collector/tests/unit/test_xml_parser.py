"""Tests for monkey_collector.xml_parser — UIElement, UITree, XML parsing."""

from monkey_collector.xml.ui_tree import UIElement, UITree, parse_bounds, parse_uiautomator_xml
