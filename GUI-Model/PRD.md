...
설정 파일 위치: `LlamaFactory/examples/custom/GUI-Model/`
...
FORCE_TORCHRUN=1 NNODES=1 NPROC_PER_NODE=4 \
  llamafactory-cli train examples/custom/GUI-Model/stage2_lora/<exp>.yaml
```
...
| 설정 파일 버전 관리 | `examples/custom/GUI-Model/` 내 YAML |
...
│   ├── examples/
│   │   └── custom/GUI-Model/ # 학습/평가 YAML 설정 파일
