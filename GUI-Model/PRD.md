...
| 스크립트 | 대응 Cell | 수행 |
|---|---|---|
| `scripts/stage1_train.sh` | 15 | Stage 1 Full FT (FORCE_TORCHRUN=1, H100×4) |
| `scripts/stage1_eval.sh`  | 21+23+24 | eval_loss + Hungarian Matching (base / fine-tuned) |
| `scripts/stage1_merge.sh` | 18 | Stage 1 Merge & HF Hub push |
...
# 전체 파이프라인 (MB, AC 순차)
./scripts/stage1_train.sh && ./scripts/stage1_merge.sh && ./scripts/stage1_eval.sh
./scripts/stage2_train.sh && ./scripts/stage2_merge.sh && ./scripts/stage2_eval.sh
